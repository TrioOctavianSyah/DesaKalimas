    ...
    <script>
        ...
        function loadDesa() {
            ...
            myDesa.forEach(element => {
                if (({!! json_encode($tempatwisata->id_desa) !!}) == element['id']) {
            ...
            <div class="col-xs-12 col-md-3">
                <div class="well">
                    ...
                    <div class="hidden-xs hidden-sm">
                        <h4 style="margin-top: -10px" align="center">Tempat Wisata lainnya</h4>
                        <br>
                        <div class="tab-content">
                            <div class="tab-pane active" id="other">
                                <div class="list-group">
                                    @forelse($list as $l)
                                        @if ($l->id == $tempatwisata->id)
                                        @else
                                            <a href="/loadDataTempatWisata/{{ $l->id }}" data-toggle="modal"
                                                class="list-group-item ">
                                                <h4 class="list-group-item-heading"><i class="fas fa-tree-palm"></i>
                                                    {{ $l->nama_tempat_wisata }}</h4>
                ...
                <div class="row point-info">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 align="center">{{ $tempatwisata->nama_tempat_wisata }}</h4>
                        </div>
