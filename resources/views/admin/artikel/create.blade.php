...
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="/admin/potensi/artikel">Manajemen Artikel Desa</a></li>
    <li class="breadcrumb-item active"><a href="/admin/artikel"></a>Tambah Data Artikel Desa</li>
@endsection
@section('add_css')
                            ...
                            <form method="POST" enctype="multipart/form-data" action="{{ route('artikel.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_artikel"
                                        placeholder="Masukkan nama artikel" required
                                        value="{{ $errors->any() ? old('nama_artikel') : '' }}">
                                ...
                                <span><button style="margin-right:4px" type="submit" class="btn btn-success float-left"><i
                                            class="fas fa-save"></i> Tambah Artikel</button></span>
