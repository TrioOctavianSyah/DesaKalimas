...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href=""></a>Edit Tempat Wisata</li>
@endsection
@section('add_css')
    <style>
        #map {
...
@section('add_js')
    ...
    <script>
        ...
        function loadMarker() {
            ...
            var marker = L.marker([tempatwisata.lat, tempatwisata.lng], {
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('tempatwisata.update', $tempatwisata->id) }}" id="form-desa"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" data-live-search="true" id="datadesa" rows="3"
                                        ...
                                        @foreach ($desa as $d)
                                            <option value="{{ $d->id }}"
                                                {{ $tempatwisata->id_desa == $d->id ? 'selected' : '' }}>{{ $d->nama_desa }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div align="center" class='col'>
                                            <img src="{{ asset('img/' . $tempatwisata->foto) }}" class="mb-3"
                                                style="border:solid #000 3px;height:60%;width:80%;" id="propic">
                                        </div>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="fototempatwisata"
                                            name="fototempatwisata"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_tempat_wisata"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lat" id="lat" readonly
                                        required value="{{ $tempatwisata->lat }}">
                                    <small style="color: red">
                                        @error('lat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lng" id="lng" readonly
                                        required value="{{ $tempatwisata->lng }}">
                                    <small style="color: red">
                                        @error('lng')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="alamat"
                                        placeholder="Masukkan alamat tempat wisata" required
                                        value="{{ $tempatwisata->alamat }}">
                                    <small style="color: red">
                                        @error('alamat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telepon"
                                        placeholder="Masukkan telepon tempat wisata" required
                                        value="{{ $tempatwisata->telepon }}">
                                    <small style="color: red">
                                        @error('telepon')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control"
                                        required>{{ $tempatwisata->keterangan }}</textarea>
                                    <small style="color: red">
                                        @error('keterangan')
                                            {{ $message }}
                                        @enderror
                                ...
                                <span><button style="margin-right:4px" type="submit"
                                        ...
                                        Data</button></span>
                                <a href="/admin/potensi/tempatwisata"><button type="button"
