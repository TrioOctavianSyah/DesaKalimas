            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('tempatwisata.store') }}" id="form-desa" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div align="center" class='col'>
                                            <img src="{{ asset('img/tempatwisata.png') }}" class="mb-3"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_tempat_wisata"
                                        ...
                                        value="{{ $errors->any() ? old('nama_tempat_wisata') : '' }}">
                                    <small style="color: red">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lat" id="lat" readonly
                                        required value="{{ $errors->any() ? old('lat') : '' }}">
                                    <small style="color: red">
                                        @error('lat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lng" id="lng" readonly
                                        required value="{{ $errors->any() ? old('lng') : '' }}">
                                    <small style="color: red">
                                        @error('lng')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="alamat"
                                        placeholder="Masukkan alamat tempatwisata" required
                                        value="{{ $errors->any() ? old('alamat') : '' }}">
                                    <small style="color: red">
                                        @error('alamat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telepon"
                                        placeholder="Masukkan telepon tempatwisata" required
                                        value="{{ $errors->any() ? old('telepon') : '' }}">
                                    <small style="color: red">
                                        @error('telepon')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control"
                                        required>{{ $errors->any() ? old('keterangan') : '' }}</textarea>
                                    <small style="color: red">
                                        @error('keterangan')
                                            {{ $message }}
                                        @enderror
                                ...
                                <span><button style="margin-right:4px" type="submit"
                                        class="btn btn-success float-left"><i class="fas fa-save"></i> Simpan
                                        Data</button></span>
