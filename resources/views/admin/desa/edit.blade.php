            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('desa.update', $desa->id) }}" id="form-desa" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kabupaten" id="kabupaten" class="form-control select2" required>
                                        ...
                                        @foreach ($kabupaten as $k)
                                            <option value="{{ $k->id }}"
                                                {{ $desa->kecamatan->id_kabupaten == $k->id ? 'selected' : '' }}>
                                                {{ $k->nama_kabupaten }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_desa"
                                        placeholder="Masukkan nama desa" required value="{{ $desa->nama_desa }}">
                                    <small style="color: red">
                                        @error('nama_desa')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control"
                                        required>{{ $desa->keterangan }}</textarea>
                                    <small style="color: red">
                                        @error('keterangan')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color" class="form-control" name="warna_batas" id="color-picker" required
                                        value="{{ $desa->warna_batas }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Batas Desa</label>
                                    <div class="input-group mb-2 mr-sm-2">
                                        <textarea placeholder="Masukan Batas Desa" name="batas_desa" id="batas" cols="30" rows="4" readonly
                                            class="form-control" required>{{ $desa->batas_desa }}</textarea>
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <a href="javascript:void(0)" id="set-data"><i
                                ...
                                <span><button style="margin-right:4px" type="submit" class="btn btn-primary float-left"><i
                                            class="fas fa-save"></i> Edit Desa</button></span>
                                <a href="/admin/desa"><button type="button" class="btn btn-danger float-left mr-2"><i
                                            class="fas fa-times"></i> Cancel</button></a>
                            </form>
                        </div>
                    </div>
                </div>
