            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('desa.store') }}" id="form-desa" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_desa"
                                        ...
                                        value="{{ $errors->any() ? old('nama_desa') : '' }}">
                                    <small style="color: red">
                                        @error('nama_desa')
                                            {{ $message }}
                                        @enderror
                                ...
                                <span><button style="margin-right:4px" type="submit" class="btn btn-success float-left"><i
                                            class="fas fa-save"></i> Tambah Desa</button></span>
