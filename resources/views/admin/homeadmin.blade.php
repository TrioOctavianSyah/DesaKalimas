    ...
    <script>
        ...
        sekolah.forEach(element => {
            ...
            var msgSekolah = "<ul class='list-unstyled'><li class='fw-bold text-center mb-2'>" + element[
                ...
                element['foto'] + "'></li><li>Jenjang: " + element['jenis'] + "</li><li>Alamat: " + element[
                    'alamat'] +
                "</li><li><a style='margin-top:7px;display: block;margin-left: auto;margin-right: auto;' class='btn btn-primary btn-sm text-white' href='/admin/potensi/sekolah/" +
        ...
        pasar.forEach(element => {
            ...
            var msgPasar = "<ul class='list-unstyled'><li class='fw-bold text-center mb-2'>" + element[
                ...
                element['foto'] + "'></li><li>No Telepon: " + element['telepon'] + "</li><li>Alamat: " + element[
                    'alamat'] +
                "</li><li><a style='margin-top:7px;display: block;margin-left: auto;margin-right: auto;' class='btn btn-primary btn-sm text-white' href='/admin/potensi/pasar/" +
                element['id'] + "'>Lihat Detail</a></li></ul>"
        ...
        tempatwisata.forEach(element => {
            ...
            var msgTempatWisata = "<ul class='list-unstyled'><li class='fw-bold text-center mb-2'>" + element[
                ...
                element['foto'] + "'></li><li>No Telepon: " + element['telepon'] + "</li><li>Alamat: " + element[
                    'alamat'] +
                "</li><li><a style='display: block;margin-left: auto;margin-right: auto;margin-top:5px;' class='btn btn-primary btn-sm text-white' href='/admin/potensi/tempatwisata/" +
                element['id'] + "'>Lihat Detail</a></li></ul>"
