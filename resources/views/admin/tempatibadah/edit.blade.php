            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('tempatibadah.update', $tempatibadah->id) }}" id="form-desa"
                                ...
                                <div class="form-group form-group mt-3">
                                    ...
                                    <select class="form-control" id="jenis" rows="3" name="agama" required>
                                        ...
                                        <option value="Kristen" {{ $tempatibadah->agama == 'Kristen' ? 'selected' : '' }}>
                                            Kristen</option>
                                        <option value="Katolik" {{ $tempatibadah->agama == 'Katolik' ? 'selected' : '' }}>
                                            Katolik</option>
                                        <option value="Konghuchu"
                                            {{ $tempatibadah->agama == 'Konghuchu' ? 'selected' : '' }}>Konghuchu</option>
                                    </select>
                                    <small style="color: red">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lat" id="lat" readonly
                                        required value="{{ $tempatibadah->lat }}">
                                    <small style="color: red">
                                        @error('lat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lng" id="lng" readonly
                                        required value="{{ $tempatibadah->lng }}">
                                    <small style="color: red">
                                        @error('lng')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="alamat"
                                        placeholder="Masukkan alamat tempat ibadah" required
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control"
                                        required>{{ $tempatibadah->keterangan }}</textarea>
                                    <small style="color: red">
                                        @error('keterangan')
                                            {{ $message }}
                                        @enderror
