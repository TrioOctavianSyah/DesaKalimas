...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href=""></a>Tambah Tempat Ibadah</li>
@endsection
@section('add_css')
    <style>
        #map {
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('tempatibadah.store') }}" id="form-desa" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div align="center" class='col'>
                                            <img src="{{ asset('img/tempatibadah.jpg') }}" class="mb-3"
                                                style="border:solid #000 3px;height:60%;width:80%;" id="propic">
                                        </div>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="fototempatibadah"
                                            name="fototempatibadah"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_tempat_ibadah"
                                        placeholder="Masukkan nama tempat ibadah" required
                                        value="{{ $errors->any() ? old('nama_tempat_ibadah') : '' }}">
                                    <small style="color: red">
                                ...
                                <span><button style="margin-right:4px" type="submit"
                                        ...
                                        Data</button></span>
                                <a href="/admin/potensi/tempatibadah"><button type="button"
