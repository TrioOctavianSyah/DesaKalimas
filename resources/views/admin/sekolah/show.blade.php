                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" data-live-search="true" id="datadesa" rows="3"
                                    ...
                                    @foreach ($desa as $d)
                                        <option value="{{ $d->id }}"
                                            {{ $sekolah->id_desa == $d->id ? 'selected' : '' }}>{{ $d->nama_desa }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_sekolah"
                                    placeholder="Masukkan nama sekolah" disabled value="{{ $sekolah->nama_sekolah }}">
                                <small style="color: red">
                                    @error('nama_sekolah')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alamat"
                                    placeholder="Masukkan alamat sekolah" disabled value="{{ $sekolah->alamat }}">
                                <small style="color: red">
                                    @error('alamat')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="telepon"
                                    placeholder="Masukkan telepon sekolah" disabled value="{{ $sekolah->telepon }}">
                                <small style="color: red">
                                    @error('telepon')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control"
                                    disabled>{{ $sekolah->keterangan }}</textarea>
                                <small style="color: red">
                                    @error('keterangan')
                                        {{ $message }}
                                    @enderror
