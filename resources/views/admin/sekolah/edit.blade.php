...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href=""></a>Edit Sekolah</li>
@endsection
@section('add_css')
    <style>
        #map {
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('sekolah.update', $sekolah->id) }}" id="form-desa" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" data-live-search="true" id="datadesa" rows="3"
                                        ...
                                        @foreach ($desa as $d)
                                            <option value="{{ $d->id }}"
                                                {{ $sekolah->id_desa == $d->id ? 'selected' : '' }}>{{ $d->nama_desa }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="fotosekolah" name="fotosekolah"
                                            onchange="this.nextElementSibling.innerText = this.files[0].name">
                                        <label for="fotosekolah" class="custom-file-label foto">.jpg/.png</label>
                                        <small style="color: red">
                                            @error('fotosekolah')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_sekolah"
                                        placeholder="Masukkan nama sekolah" required value="{{ $sekolah->nama_sekolah }}">
                                    <small style="color: red">
                                        @error('nama_sekolah')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group form-group mt-3">
                                    ...
                                    <select class="form-control" id="jenis" rows="3" name="jenis_sekolah"
                                        required>
                                        <option value="" {{ $sekolah->jenis == null ? 'selected' : '' }}>Pilih jenis
                                            sekolah</option>
                                        <option value="PAUD" {{ $sekolah->jenis == 'PAUD' ? 'selected' : '' }}>PAUD
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="alamat"
                                        placeholder="Masukkan alamat sekolah" required value="{{ $sekolah->alamat }}">
                                    <small style="color: red">
                                        @error('alamat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telepon"
                                        placeholder="Masukkan telepon sekolah" required value="{{ $sekolah->telepon }}">
                                    <small style="color: red">
                                        @error('telepon')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control"
                                        required>{{ $sekolah->keterangan }}</textarea>
                                    <small style="color: red">
                                        @error('keterangan')
                                            {{ $message }}
                                        @enderror
                                ...
                                <span><button style="margin-right:4px" type="submit"
                                        class="btn btn-primary float-left"><i class="fas fa-save"></i> Edit
                                        Data</button></span>
                                <a href="/admin/potensi/sekolah"><button type="button"
                                        class="btn btn-danger float-left mr-2"><i class="fas fa-times"></i>
                                        Kembali</button></a>
                            </form>
                        </div>
                    </div>
