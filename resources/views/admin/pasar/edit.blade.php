...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href=""></a>Edit Pasar</li>
@endsection
@section('add_css')
    <style>
        #map {
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pasar.update', $pasar->id) }}" id="form-desa" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" data-live-search="true" id="datadesa" rows="3"
                                        ...
                                        @foreach ($desa as $d)
                                            <option value="{{ $d->id }}"
                                                {{ $pasar->id_desa == $d->id ? 'selected' : '' }}>{{ $d->nama_desa }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="fotopasar" name="fotopasar"
                                            onchange="this.nextElementSibling.innerText = this.files[0].name">
                                        <label for="fotopasar" class="custom-file-label foto">.jpg/.png</label>
                                        <small style="color: red">
                                            @error('fotopasar')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_pasar"
                                        placeholder="Masukkan nama Pasar" required value="{{ $pasar->nama_pasar }}">
                                    <small style="color: red">
                                        @error('nama_pasar')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="alamat"
                                        placeholder="Masukkan alamat Pasar" required value="{{ $pasar->alamat }}">
                                    <small style="color: red">
                                        @error('alamat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telepon"
                                        placeholder="Masukkan telepon Pasar" required value="{{ $pasar->telepon }}">
                                    <small style="color: red">
                                        @error('telepon')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control"
                                        required>{{ $pasar->keterangan }}</textarea>
                                    <small style="color: red">
                                        @error('keterangan')
                                            {{ $message }}
                                        @enderror
                                ...
                                <span><button style="margin-right:4px" type="submit"
                                        ...
                                        Data</button></span>
                                <a href="/admin/potensi/pasar"><button type="button"
