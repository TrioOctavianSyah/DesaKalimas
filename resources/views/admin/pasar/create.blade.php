...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href=""></a>Tambah Pasar</li>
@endsection
@section('add_css')
    <style>
        #map {
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pasar.store') }}" id="form-desa" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div align="center" class='col'>
                                            <img src="{{ asset('img/pasar.png') }}" class="mb-3"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_pasar"
                                        ...
                                        value="{{ $errors->any() ? old('nama_pasar') : '' }}">
                                    <small style="color: red">
                                        @error('nama_pasar')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telepon"
                                        placeholder="Masukkan telepon pasar" required
